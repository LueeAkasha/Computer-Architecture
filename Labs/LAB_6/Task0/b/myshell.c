...
void addProcess(process** process_list, cmdLine* cmd, pid_t pid){    
    if(*process_list == NULL){
        process *  processToAdd = calloc(1, sizeof(process));
             //fprintf(stdout, "process mem allocated in line: 31 \n");   
    ...
    {
        process *  processToAdd = calloc(1, sizeof(process));
            //  fprintf(stdout, "process mem allocated in line: 47 \n");   
    ...
    while(1){
        ...
        if (strcmp(pCmdLine->arguments[0], "cd")==0){
            ...
            newPath = calloc( last_index + 1,1);
             //fprintf(stdout, "string mem allocated in line: 265 \n");   
            ...
            free(newPath);
            // fprintf(stdout, "string mem freed in line: 276 \n");   
